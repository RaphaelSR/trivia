...
export function ControlShell({ topbar, statusStrip, sidebar, children, sidebarCollapsed = false }: ControlShellProps) {
  return (
    <div className="relative z-10 flex h-screen flex-col overflow-hidden" style={{ background: 'transparent' }}>
      {topbar}
      {statusStrip}
      <div className="flex min-h-0 flex-1">
        <div className={clsx('shrink-0', sidebarCollapsed ? 'xl:w-[64px]' : 'xl:w-[220px]')}>
          {sidebar}
        </div>
