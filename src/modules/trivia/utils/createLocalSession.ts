...
const defaultParticipants = [
  { id: 'participant-1', name: 'João', role: 'host' as const, teamId: 'team-1' },
  { id: 'participant-2', name: 'Cris', role: 'player' as const, teamId: 'team-1' },
  { id: 'participant-3', name: 'Dani', role: 'player' as const, teamId: 'team-1' },
  { id: 'participant-4', name: 'Cami', role: 'player' as const, teamId: 'team-2' },
  { id: 'participant-5', name: 'Mi', role: 'player' as const, teamId: 'team-2' },
  { id: 'participant-6', name: 'Rapha', role: 'assistant' as const, teamId: 'team-2' },
]
