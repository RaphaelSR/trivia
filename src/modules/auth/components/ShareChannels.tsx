    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap gap-1.5">
        ...
        <button
          ...
          aria-label={t('sharing.copyLabel', { label })}
          className={[
        ...
        <a
          ...
          aria-label={t('sharing.whatsappLabel', { label })}
        ...
        <a
          href={mailHref}
          aria-label={t('sharing.emailLabel', { label })}
          className="inline-flex items-center gap-1 rounded-lg border border-white/10 bg-white/5 px-2.5 py-1 text-[11px] font-medium text-[var(--color-text)] transition-colors hover:bg-white/10"
        >
        ...
        <button
          ...
          aria-label={showQr ? t('sharing.hideQr') : t('sharing.showQr', { label })}
      ...
      {showQr && (
        <div className="flex flex-col items-center gap-1 pt-1">
          <LocalQrCode value={url} label={t('sharing.qrLabel', { label })} size={160} />
