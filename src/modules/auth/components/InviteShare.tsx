...
function InviteBlock({ name, token }: InviteBlockProps) {
  ...
  async function handleCopy() {
    try {
      ...
      // Fallback: exibe input readonly e seleciona o texto
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-1.5">
        ...
        >
          {/* WhatsApp icon via SVG inline (sem dependência extra) */}
          <svg
            viewBox="0 0 24 24"
      ...
      {/* QR Code — serviço externo: api.qrserver.com (gratuito, sem autenticação).
          Aceitável para links de convite não-secretos; o QR é gerado somente
          quando o usuário clica "Mostrar QR", evitando requisições automáticas. */}
      {showQr && (
